<?php
	...
	if (isset($_SESSION['logged_on'])) {
		...
		if ($exceededSpace) {
			echo "<span style='color:#FF0000; font-weight: bold;'>You have exceeded your quota (".$quota."G) please clear space by deleting and/or minimizing projects and then reload to add new genome.</span><br><br>";
		}
	}
?>
<html lang="en">

	...
	for chr_to_draw  = 1:length(chr_order)
		...
		if (chr_in_use(chr) == 1)
			...
			if (chr_figReversed(chr) == 0)
				...
				text(-50000/bases_per_bin/2*3, maxY/2,[chr_label{chr} '\fontsize{' int2str(round(linear_chr_font_size/2)) '}(reversed)'], 'Rotation',90, 'HorizontalAlignment','center', 'VerticalAlign','bottom', 'Fontsize',stacked_chr_font_size);
			end;

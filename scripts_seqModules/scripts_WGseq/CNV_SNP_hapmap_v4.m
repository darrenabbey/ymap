	...
	if (chr_in_use(chr) == 1)
		...
		if (Standard_display)
			...
			if (chr_figReversed(chr) == 0)
				...
				text(-50000/5000/2*3, maxY/2,[chr_label{chr} char(10) '(reversed)'], 'rotation', 90, 'horizontalalignment', 'center', 'verticalalignment', 'bottom', 'fontsize', stacked_chr_font_size/2);
			end;
			switch ploidyBase
				case 1

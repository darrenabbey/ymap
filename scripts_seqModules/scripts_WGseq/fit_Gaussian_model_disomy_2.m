...
%--------------------------------------------------------------------------
	...
	p1_a = max([data(round(locations(1))) data(round(locations(1))+1)])/max(data);     p1_b = locations(1);    p1_c = abs(Estimates(2));
        p2_a =      data(round(locations(2)))                              /max(data);     p2_b = locations(2);    p2_c = abs(Estimates(4));
        p3_a = max([data(round(locations(3))) data(round(locations(3))-1)])/max(data);     p3_b = locations(3);    p3_c = abs(Estimates(2));
...
function sse = fiterror(params,time,data,func_type,locations,show)
	...
	p2_a =      data(round(locations(2)))                              /max(data);     p2_b = locations(2);    p2_c = abs(params(4));
	p3_a = max([data(round(locations(3))) data(round(locations(3))-1)])/max(data);     p3_b = locations(3);    p3_c = abs(params(2));

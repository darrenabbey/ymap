...
function sse = fiterror(params,time,data,func_type,locations)
	...
	p2_a = abs(params(2));								p2_b = locations(2);	p2_c = abs(params(3));	alpha_2 = params(7);
	p3_a = abs(params(4));								p3_b = locations(3);	p3_c = abs(params(3));	alpha_3 = params(8);
	p4_a = abs(params(5));								p4_b = locations(4);	p4_c = abs(params(3));	alpha_4 = -params(8);
	p5_a = abs(params(6));								p5_b = locations(5);	p5_c = abs(params(3));	alpha_5 = -params(7);

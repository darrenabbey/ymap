...
function sse = fiterror(params,time,data,func_type,locations)
	...
	p3_a = abs(params(4));									p3_b = locations(3);	p3_c = abs(params(3));  alpha_3 = params(9);
	p4_a = abs(params(5));									p4_b = locations(4);	p4_c = abs(params(3));
	p5_a = abs(params(6));									p5_b = locations(5);	p5_c = abs(params(3));  alpha_5 = params(9);
	p6_a = abs(params(7));									p6_b = locations(6);	p6_c = abs(params(3));  alpha_6 = -params(8);

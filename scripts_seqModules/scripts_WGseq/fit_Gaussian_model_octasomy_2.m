function [p1_a,p1_b,p1_c, p2_a,p2_b,p2_c, p3_a,p3_b,p3_c, p4_a,p4_b,p4_c, p5_a,p5_b,p5_c, p6_a,p6_b,p6_c, p7_a,p7_b,p7_c, p8_a,p8_b,p8_c, p9_a,p9_b,p9_c, skew_factor] = fit_Gaussian_model_octasomy_2(workingDir, saveName, data,locations,init_width,func_type)
	...
	p9_b         = locations(9);
	p9_c         = abs(Estimates(2));

	skew_factor1 = 1; %abs(Estimates(19));
	skew_factor2 = 1; %abs(Estimates(20));
	skew_factor3 = 1; %abs(Estimates(21));
	skew_factor4 = 1; %abs(Estimates(22));
	skew_factor5 = 1;
	skew_factor6 = 1; %2-abs(Estimates(22));
	skew_factor7 = 1; %2-abs(Estimates(21));
	skew_factor8 = 1; %2-abs(Estimates(20));
	skew_factor9 = 1; %2-abs(Estimates(19));
...
function sse = fiterror(params,time,data,func_type,locations,show)
	...
	p9_c         = abs(params(2)); % abs(params(18));  % width.

	skew_factor1 = 1; %abs(params(19));
	skew_factor2 = 1; %abs(params(20));
	skew_factor3 = 1; %abs(params(21));
	skew_factor4 = 1; %abs(params(22));
	skew_factor5 = 1;
	skew_factor6 = 1; %2-abs(params(22));
	skew_factor7 = 1; %2-abs(params(21));
	skew_factor8 = 1; %2-abs(params(20));
	skew_factor9 = 1; %2-abs(params(19));

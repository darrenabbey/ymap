...
<DIV id="Hidden_UpdateDataset" style="display: none; position: absolute; border: solid black 1px; padding: 5px; text-align: justify;">
	...
	<td width="5%" align="right"><div onmousedown="document.getElementById('Hidden_UpdateDataset').style.display = 'none';if (parent.parent.document.getElementById('panel_manageDataset_iframe').contentDocument.getElementById('pending_comment').style.visibility != 'visible') { parent.parent.document.getElementById('panel_manageDataset_iframe').contentWindow.location.reload(); parent.parent.document.getElementById('panel_visualizeDataset_iframe').contentWindow.location.reload(); parent.parent.document.getElementById('panel_admin2_iframe').contentWindow.location.reload();}" style="display:inline-block;"><b>[X]</b></div></td>
	</tr></table>
	<br>

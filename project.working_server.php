...
<?php
	...
	if (file_exists($dirFigureBase."complete.txt")) {
		...
		?>
		<html>
		<body onload = "parent.parent.update_project_label_color('<?php echo $key; ?>','#00AA00'); parent.parent.resize_project('<?php echo $key; ?>', 0); parent.parent.update_project_remove_iframe('<?php echo $key; ?>', '<?php echo htmlspecialchars(json_encode(scandir(\"users/<?php echo $user; ?>/projects/<?php echo $project; ?>\"))); ?>');">
		</body>
		</html>
		<?php

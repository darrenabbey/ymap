function minimizeProjectConfirmation(project,key){
	...
	dom_object.innerHTML     = "<b><font color=\"red\">[Minimized projects can't be used for further analysis. Are you sure?]</font>";
	dom_object.innerHTML    += "<button type='button' onclick='parent.minimizeProject_no(\""+project+"\",\""+key+"\")'>No, cancel</button>";
